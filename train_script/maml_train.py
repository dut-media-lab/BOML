...
def train_and_test(metasets, name_of_exp,method, inner_method, outer_method, use_T=False, use_Warp=False,
    ...
    exs, pybml_ho, saver = build(metasets, learn_lr, lr0,
                                 MBS, T, mlr0, process_fn,method, inner_method, outer_method, use_T, use_Warp, first_order,reptile)
...
# training and testing function
def build_and_test(metasets, exp_dir,method, inner_method, outer_method, use_T=False,use_Warp=False, first_order=False,reptile=False,
    ...
    exs, pybml_ho, saver = build(metasets, learn_lr, lr0,
                                 ...
                                 regularization,alpha,method, inner_method, outer_method, use_T,use_Warp, first_order,reptile)
