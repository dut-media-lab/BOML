...
class BOMLOptAdam(BOMLOpt, tf.train.AdamOptimizer):
    ...
    def apply_gradients(self, grads_and_vars, global_step=None, name=None):
        update_op = super(BOMLOptAdam, self).apply_gradients(grads_and_vars, global_step, name)
    ...
    def optimizer_params_tensor(self):
        return super(BOMLOptAdam, self).optimizer_params_tensor + [self._beta1_t, self._beta2_t]
