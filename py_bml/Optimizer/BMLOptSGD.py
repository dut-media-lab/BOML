...
class BMLOptSGD(BMLOpt, tf.train.GradientDescentOptimizer):

    def __init__(self, learning_rate, use_locking=False, name='GradientDescent'):
        super(BMLOptSGD, self).__init__(learning_rate, use_locking, name)
    ...
    def apply_gradients(self, grads_and_vars, global_step=None, name=None):
        ...
        update_op = super(BMLOptSGD, self).apply_gradients(grads_and_vars, global_step, name)
