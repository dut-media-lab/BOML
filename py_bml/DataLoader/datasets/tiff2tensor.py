...
from py_bml.DataLoader.datasets.load_full_dataset import MINI_IMAGENET_FOLDER_RES84
...
def convert_mini_imagenet(_folder=None, resize=None):
    for st in ['train', 'val', 'test']:
        ...
        h5file = h5py.File(os.path.join(_folder or MINI_IMAGENET_FOLDER_RES84, '%s.h5' % st), 'w')
