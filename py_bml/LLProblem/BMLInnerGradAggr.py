...
class BMLInnerGradAggr(BMLInnerGradTrad):
    ...
    def compute_gradients(bml_opt, loss_inner, loss_outer=None, param_dict=OrderedDict(),
        ...
        update_op, dynamics = BMLInnerGradAggr.bml_inner_grad_aggr(inner_optimizer=bml_opt, loss_inner=loss_inner,
                                                                   loss_outer=loss_outer, param_dict=param_dict,
                                                                   var_list=var_list, *minimize_kargs)
        return BMLInnerGradAggr(update_op=update_op, dynamics=dynamics, objective=loss_inner,
    ...
    def bml_inner_grad_aggr(inner_optimizer, loss_inner, loss_outer, param_dict=OrderedDict(), global_step=None,
        ...
        grads_and_vars = BMLInnerGradAggr.combine_grads(inner_grads=grads_and_vars_inner,
    ...
    def __lt__(self, other):  # make OptimizerDict sortable
        ...
        assert isinstance(other, BMLInnerGradAggr)
