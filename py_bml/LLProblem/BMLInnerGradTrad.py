...
class BMLInnerGradTrad(object):
    ...
    @staticmethod
    def compute_gradients(bml_opt, loss_inner, loss_outer=None, param_dict=OrderedDict(), var_list=None,
                 **inner_kargs):
        ...
        return BMLInnerGradTrad(update_op=update_op, dynamics=dynamics, objective=loss_inner)  # loss_inner
    ...
    def __lt__(self, other):  # make OptimizerDict sortable
        ...
        assert isinstance(other, BMLInnerGradTrad)
