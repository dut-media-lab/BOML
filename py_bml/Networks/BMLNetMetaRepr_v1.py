...
class BMLNetMetaRepr_v1(BMLNet):
    ...
    def __init__(self, _input, name='BMLNetC4LMetaRepr', outer_param_dict=OrderedDict(),
        ...
        super(BMLNetMetaRepr_v1, self).__init__(_input=_input, outer_param_dict=outer_param_dict,
    ...
    def re_forward(self, new_input):
        return BMLNetMetaRepr_v1(_input=new_input if new_input is not None else self.layers[0], name=self.name,
...
def BMLNetOmniglotMetaRepr_v1(_input, outer_param_dict=OrderedDict(),model_param_dict=OrderedDict(),
                              batch_norm=True, name='BMLNetC4LOmniglot', use_T=False,
                              use_Warp=False, outer_method='Reverse',**model_args):

    return BMLNetMetaRepr_v1(_input=_input, name=name,model_param_dict=model_param_dict,
                             outer_param_dict=outer_param_dict, norm=batch_norm, use_T=use_T, use_Warp=use_Warp,
                             outer_method=outer_method,**model_args)


def BMLNetMiniMetaRepr_v1(_input, outer_param_dict=OrderedDict(),model_param_dict=OrderedDict(),
                          batch_norm=True, name='BMLNetC4LMini', use_T=False,
                          use_Warp=False, outer_method='Reverse',**model_args):
    return BMLNetMetaRepr_v1(_input=_input, name=name, use_T=use_T,  use_Warp=use_Warp,
